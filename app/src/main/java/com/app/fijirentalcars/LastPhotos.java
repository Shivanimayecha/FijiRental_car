...
public class LastPhotos extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last_photos);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.iv_back){
            ...
            Intent i = new Intent(this, GetReadyPhotos.class);
            i.putExtra(FijiRentalUtils.CAR_FLAW,true);
            startActivity(i);
        }
    }
