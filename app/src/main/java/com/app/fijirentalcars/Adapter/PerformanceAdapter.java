...
public class PerformanceAdapter extends RecyclerView.Adapter<PerformanceAdapter.ViewHolder>{
    ...
    public PerformanceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.item_layout_performance, parent, false);
        PerformanceAdapter.ViewHolder viewHolder = new PerformanceAdapter.ViewHolder(listItem);
        return viewHolder;
    }
