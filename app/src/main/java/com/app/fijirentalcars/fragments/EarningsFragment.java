...
public class EarningsFragment extends Fragment implements View.OnClickListener, PopUpAdapter.OnSelectListner,PopupSubAdapter.ItemSelect {
    ...
    CircleImageView ivPlus;
    List itemList= Arrays.asList("2022","2021");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("EarningsFragment","EarningsFragment");
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.iv_plus){
            ...
            PopUpAdapter popUpAdapter=new PopUpAdapter(getContext(),itemList,this, FijiRentalUtils.EarningFilter);
    ...
    public void onSelect(String val) {
        FijiRentalUtils.EarningFilter=val;
        dialog.dismiss();
    }

    private void getVehicleData() {

        FijiRentalUtils.Logger("YAGS","Earning frag");
